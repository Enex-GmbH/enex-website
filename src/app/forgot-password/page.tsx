...
export default function ForgotPasswordPage() {
  ...
  const onSubmit = async (data: ForgotPasswordFormData) => {
    ...
    try {
      ...
      if (!result.success) {
        setError(result.error || "Fehler beim Anfordern des Reset-Links");
        setIsLoading(false);
        return;
      }
      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md p-8">
          ...
          <p className="text-gray-600 mb-6">
            Wenn ein Konto mit dieser E-Mail-Adresse existiert, wurde ein Link
            zum Zurücksetzen des Passworts gesendet. Bitte überprüfen Sie Ihr
            Postfach.
          </p>
          <Link href="/login">
